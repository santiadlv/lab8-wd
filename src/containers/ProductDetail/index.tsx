...
class ProductDetail extends React.Component<{}, ProductState> {
    ...
    changedSize = (event: any) => {
        ...
        const chosenSku = this.state.helper.getSku(this.state.selectedColor, value);
    ...
    logSku = (event: any) => {
        let printedSku = this.state.helper.getSku(this.state.selectedColor, this.state.selectedSize);
